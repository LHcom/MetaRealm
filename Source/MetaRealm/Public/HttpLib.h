...
private:
	const FString ServerURL = "http://125.132.216.190:7777";
	const FString SignUpURL = ServerURL + "/signup"; // 회원가입
	const FString LoginURL = ServerURL + "/login"; // 로그인
	const FString SoundToTextURL = ServerURL + "/v1/xr/stt"; // STT (회의 요약)
